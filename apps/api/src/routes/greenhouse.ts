...
router.post("/", async (req: Request, res: Response) => {
  try {
    ...
    if (error instanceof Error) {
      return res
        .status(500)
        .json({ message: "Error creating greenhouse", error: error.message });
    }
...
router.get("/", async (req: Request, res: Response) => {
  try {
    ...
    if (error instanceof Error) {
      return res
        .status(500)
        .json({ message: "Error fetching greenhouses", error: error.message });
    }
...
router.get("/:id", async (req: Request, res: Response) => {
  try {
    ...
    if (error instanceof Error) {
      return res
        .status(500)
        .json({ message: "Error fetching greenhouse", error: error.message });
    }
...
router.put("/:id", async (req: Request, res: Response) => {
  try {
    ...
    if (error instanceof Error) {
      return res
        .status(500)
        .json({ message: "Error updating greenhouse", error: error.message });
    }
...
router.delete("/:id", async (req: Request, res: Response) => {
  try {
    ...
    if (error instanceof Error) {
      return res
        .status(500)
        .json({ message: "Error deleting greenhouse", error: error.message });
    }
